...
if ($keywordmis == 1){
	if ($shortcode != ""){
		if ($shortcode == "all"){
			if ($keyword == "all"){
				$sqlquery = "select msisdn, score, question_counter, question_correctly_answered, keyword, shortcode, voting_id from voting_session where entry_datetime >= '" . $start_date . "' and entry_datetime <= '" . $end_date . "'  and sms_type='1' order by id desc";
			}else{
				$sqlquery = "select msisdn, score, question_counter, question_correctly_answered, keyword, shortcode, voting_id from voting_session where entry_datetime >= '" . $start_date . "' and entry_datetime <= '" . $end_date . "' and keyword='" . $keyword . "'  and sms_type='1' order by id desc";
			}
		}else{
			if ($keyword == "all"){
				$sqlquery = "select msisdn, score, question_counter, question_correctly_answered, keyword, shortcode, voting_id from voting_session where entry_datetime >= '" . $start_date . "' and entry_datetime <= '" . $end_date . "' and shortcode='" . $shortcode . "'  and sms_type='1' order by id desc";
			}else{
				$sqlquery = "select msisdn, score, question_counter, question_correctly_answered, keyword, shortcode, voting_id from voting_session where entry_datetime >= '" . $start_date . "' and entry_datetime <= '" . $end_date . "' and shortcode='" . $shortcode . "' and keyword='" . $keyword . "'  and sms_type='1' order by id desc";
			}
		}
	}
}else{
	if ($cntsid == "all"){
		...
		if ($sms_type == 1){
			if ($shortcode != ""){
				if ($shortcode == "all"){
					$sqlquery = "select msisdn, score, question_counter, question_correctly_answered, keyword, shortcode, voting_id from voting_session where entry_datetime >= '" . $start_date . "' and entry_datetime <= '" . $end_date . "' and voting_id='" . $cntsid . "'  and sms_type='1' order by id desc";
				}else{
					$sqlquery = "select msisdn, score, question_counter, question_correctly_answered, keyword, shortcode, voting_id from voting_session where entry_datetime >= '" . $start_date . "' and entry_datetime <= '" . $end_date . "' and shortcode='" . $shortcode . "' and voting_id='" . $cntsid . "'  and sms_type='1' order by id desc";
				}
			}
		}else{
			$sqlquery = "select msisdn, score, question_counter, question_correctly_answered, keyword, shortcode, voting_id from voting_session where entry_datetime >= '" . $start_date . "' and entry_datetime <= '" . $end_date . "' and voting_id='" . $cntsid . "' and sms_type<>'1' order by id desc";
...
//$sqlquery = "select msisdn, score, question_counter, question_correctly_answered from voting_session where voting_id='" . $cntsid . "'";
//echo $sqlquery;
...
if ($keywordmis == 1){
	if ($shortcode != ""){
		if ($shortcode == "all"){
			if ($keyword == "all"){
				$sqlquery1 = "select msisdn, score, question_counter, question_correctly_answered, keyword, shortcode, voting_id from voting_session where entry_datetime >= '" . $start_date . "' and entry_datetime <= '" . $end_date . "'  and sms_type='1' order by id desc limit $eu, $limit";
			}else{
				$sqlquery1 = "select msisdn, score, question_counter, question_correctly_answered, keyword, shortcode, voting_id from voting_session where entry_datetime >= '" . $start_date . "' and entry_datetime <= '" . $end_date . "' and keyword='" . $keyword . "'  and sms_type='1' order by id desc limit $eu, $limit";
			}
		}else{
			if ($keyword == "all"){
				$sqlquery1 = "select msisdn, score, question_counter, question_correctly_answered, keyword, shortcode, voting_id from voting_session where entry_datetime >= '" . $start_date . "' and entry_datetime <= '" . $end_date . "' and shortcode='" . $shortcode . "'  and sms_type='1' order by id desc limit $eu, $limit";
			}else{
				$sqlquery1 = "select msisdn, score, question_counter, question_correctly_answered, keyword, shortcode, voting_id from voting_session where entry_datetime >= '" . $start_date . "' and entry_datetime <= '" . $end_date . "' and shortcode='" . $shortcode . "' and keyword='" . $keyword . "'  and sms_type='1' order by id desc limit $eu, $limit";
			}
		}
	}
}else{
	if ($cntsid == "all"){
		...
		if ($sms_type == 1){
			if ($shortcode != ""){
				if ($shortcode == "all"){
					$sqlquery1 = "select msisdn, score, question_counter, question_correctly_answered, keyword, shortcode, voting_id from voting_session where entry_datetime >= '" . $start_date . "' and entry_datetime <= '" . $end_date . "' and voting_id='" . $cntsid . "'  and sms_type='1' order by id desc limit $eu, $limit";
				}else{
					$sqlquery1 = "select msisdn, score, question_counter, question_correctly_answered, keyword, shortcode, voting_id from voting_session where entry_datetime >= '" . $start_date . "' and entry_datetime <= '" . $end_date . "' and shortcode='" . $shortcode . "' and voting_id='" . $cntsid . "'  and sms_type='1' order by id desc limit $eu, $limit";
				}
			}
		}else{
			$sqlquery1 = "select msisdn, score, question_counter, question_correctly_answered, keyword, shortcode, voting_id from voting_session where entry_datetime >= '" . $start_date . "' and entry_datetime <= '" . $end_date . "' and voting_id='" . $cntsid . "' and sms_type<>'1' order by id desc limit $eu, $limit";
...
if ($cntsid == "all"){
	if ($keyword == "all"){
		$sqlquery1 = "select msisdn, score, question_counter, question_correctly_answered, keyword, voting_id from voting_session where entry_datetime >= '" . $start_date . "' and entry_datetime <= '" . $end_date . "'  and sms_type='1' order by id desc limit $eu, $limit";
	}elseif ($keyword != ""){
		$sqlquery1 = "select msisdn, score, question_counter, question_correctly_answered, keyword, voting_id from voting_session where entry_datetime >= '" . $start_date . "' and entry_datetime <= '" . $end_date . "' and keyword='" . $keyword . "'  and sms_type='1' order by id desc limit $eu, $limit";
	}else{
		$sqlquery1 = "select msisdn, score, question_counter, question_correctly_answered, keyword, voting_id from voting_session where entry_datetime >= '" . $start_date . "' and entry_datetime <= '" . $end_date . "'  and sms_type='1' order by id desc limit $eu, $limit";
	}
}else{
	if ($keyword == "all"){
		$sqlquery1 = "select msisdn, score, question_counter, question_correctly_answered, keyword, voting_id from voting_session where voting_id='" . $cntsid . "' and entry_datetime >= '" . $start_date . "' and entry_datetime <= '" . $end_date . "'  and sms_type='1' order by id desc limit $eu, $limit";
	}elseif ($keyword != ""){
		$sqlquery1 = "select msisdn, score, question_counter, question_correctly_answered, keyword, voting_id from voting_session where voting_id='" . $cntsid . "' and entry_datetime >= '" . $start_date . "' and entry_datetime <= '" . $end_date . "' and keyword='" . $keyword . "'  and sms_type='1' order by id desc limit $eu, $limit";
	}else{
		$sqlquery1 = "select msisdn, score, question_counter, question_correctly_answered, keyword, voting_id from voting_session where voting_id='" . $cntsid . "' and entry_datetime >= '" . $start_date . "' and entry_datetime <= '" . $end_date . "'  and sms_type='1' order by id desc limit $eu, $limit";
	}
}
	...
	<table align="left" border="0" cellspacing="0" cellpadding="0" width="748px" bgcolor="#525200">
		<tr><td>
			<table align="center" border="0" cellspacing="0" cellpadding="0" width="748px" bgcolor="#f4f4e4">
				<TR height="22px"><TD class="WorkWht" background="images/menustrip.gif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;MIS</TD></tr>
				<tr><td>
									...
									?>
										<tr bgcolor="#D9D9A8">
											<td align="right" class="WorkBlack">
												<?if ($keywordmis == 1){?>
													<a target='blank' class='WorkBlueNormal' href='vmsisdndetail.php?msisdn=<? echo $msisdn ?>&cnts_id=<? echo $cntsid ?>&sess_id=<? echo $sess_id ?>&rand=<? echo $rand ?>&login=<? echo $login_form ?>&start_date=<? echo $start_date ?>&end_date=<? echo $end_date ?>&cbo_sgroup=<? echo $keyword ?>&cbo_group=<? echo $shortcode ?>&keywordmis=<? echo $keywordmis ?>'><? echo $msisdn?></a>
												<?}else{?>
													<a target='blank' class='WorkBlueNormal' href='vmsisdndetail.php?msisdn=<? echo $msisdn ?>&cnts_id=<? echo $cntsid ?>&sess_id=<? echo $sess_id ?>&rand=<? echo $rand ?>&login=<? echo $login_form ?>&start_date=<? echo $start_date ?>&end_date=<? echo $end_date ?>&keyword=<? echo $keyword ?>&shortcode=<? echo $shortcode ?>&sms_type=<? echo $sms_type ?>&mistype=<? echo $mistype ?>'><? echo $msisdn?></a>
												<?}?>
											</td>
						...
						<?}else{?>
							<?if ($sms_type == 1 || $keywordmis == 1){?>
								<table align="left" border="0" cellspacing="1" cellpadding="1" width="748px" bgcolor="#525200" style="table-layout:fixed;">
									...
									<tr height="16px" bgcolor="#D9D9A8">
										<td width="100px" align="center"><b>Msisdn</b></td>
										<td width="100px" align="center"><b>Voting Name</b></td>
										<td width="100px" align="center"><b>Keyword</b></td>
									</tr>
									...
									<?while ($noticia = mysql_fetch_array($result1)){
										...
										$sqlquery = "select voting_name from voting_detail where voting_id='" . $cnts_id . "'";
										$result = mysql_query($sqlquery) or die('mysql error:' . mysql_error());
