...
function hheader($smenu)
{
	...
	else if ($smenu==9) 
	{
		...
		while($row2 = mysql_fetch_row($result2))
		{
			...
			echo $companyName=$row[10];
			echo $user_type	 = $row[14];
			die();
			$i = $i + 1;
		}
		//$archivelnk="Archive Map";
...
// 	else
// 	{
// 		ADDEXTPARMVAL = "?login=<? echo  $login_form ?>&companyName=<? echo  $companyName ?>&sess_id=<? echo  $sess_id ?>&smenu=<? echo  $smenu ?>&&trgt_selctn=1"
// 	}
	USETEXTLINKS = 1
	STARTALLOPEN = 0
	USEFRAMES = 0
...
<table border="0" cellspacing="0" cellpadding="0" width="960" align="center">
		...
		<table border="0" cellspacing="0" cellpadding="0" width="960" align="center">
			...
			<tr height="22">
				...
				<td align="right" class="WorkWht">
					...
					<a class="item1" href="javascript:void(0)"; onClick="JavaScript:closeWindow();" />
	...
	<tr>
		...
		<table border="0" cellspacing="0" cellpadding="0" width="960"
			align="center">
			<tr height="32">
			<?if($login_form=='admin' || $login_form=='mslShafi'){?>
	...
	<tr>
		<td>
		<table border="0" cellspacing="0" cellpadding="0" width="960"
			align="left" id="menu1" class="ddm1">
			<tr bgcolor="#525200" height="32">
				<td ALIGN="center">&nbsp;</td>
			</tr>
			<?}?>
		</table>
