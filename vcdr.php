...
<form name="contest_form" action="vcdr1.php" method="post" onsubmit="return isValid()">
    ...
    <tr>
        <td>
            <table align="center" border="0" cellspacing="0" cellpadding="0" width="748px" bgcolor="#f4f4e4">
                <TR height="26">
                    <TD align="left" class="WorkWht" background="images/trgt_hdr1.gif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/3.png" border="0">&nbsp;&nbsp;&nbsp;CDR</TD>
                    ...
                    <td colspan="2">
                        ...
                        <?}?>
							...
							<tr height="20px" bgcolor="#D9D9A8">
								<td align="right" class="WorkGreen">Year&nbsp;:&nbsp;</td>
							...
							<tr height="20px" bgcolor="#D9D9A8">
								<td align="right" class="WorkGreen">Month&nbsp;:&nbsp;</td>
								<td align="left" class="WorkGreen" colspan="2">
								...
								<td colspan="3">
									<div id="txtsms" <? if($sms_type==1||!$sms_type){echo "style=\"display:inline\"";}else{echo "style=\"display:none\"";} ?>>
										<table border="0" cellspacing="0" cellpadding="0" width="748px">
											...
											<tr height="16" bgcolor="#D9D9A8">
												<td align="center" class="WorkGreen" colspan="3"><input type="button" class="submit1" value="Submit Here!!!" onclick="contest_cdr('contest_form');" style="background-image:url('images/menu1.gif');" tabindex="33"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
											</tr>
							...
							<tr height="1px" bgcolor="#D9D9A8">
								<td colspan="3">
									<div id="wapsms" <? if($sms_type==2){echo "style=\"display:inline\"";}else{echo "style=\"display:none\"";} ?>>
										<table border="0" cellspacing="0" cellpadding="0" width="748px">
											<tr height="16" bgcolor="#D9D9A8">
												<td align="center" class="WorkGreen" colspan="3"><input type="button" class="submit1" value="Submit Here!!!" onclick="contest_cdr1('contest_form');" style="background-image:url('images/menu1.gif');" tabindex="33"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
											</tr>
										</table>
									</div>
								</td>
