	...
	if ($shortcode != ""){
		if ($shortcode == "all"){
			if ($keyword == "all"){
				...
				$sqlquery = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and keyword='" . $keyword . "' and sms_type='1'";
			}
		}else{
			if ($keyword == "all"){
				$sqlquery = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and shortcode='" . $shortcode . "' and sms_type='1'";
			}else{
				$sqlquery = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and shortcode='" . $shortcode . "' and keyword='" . $keyword . "' and sms_type='1'";
			}
		}
	}
}else{
		...
		if ($sms_type == 1){
			if ($shortcode != ""){
				if ($shortcode == "all"){
					...
					$sqlquery = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and contest_id='" . $cntsid . "' and shortcode='" . $shortcode . "' and sms_type='1'";
				}
			}
		}else{
			$sqlquery = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and contest_id='" . $cntsid . "' and sms_type<>'1'";
...
//$sqlquery = "select msisdn, score,contest_id,keyword,shortcode from today_score where contest_id='" . $cntsid . "' and day(entry_date)='" . $s_day . "' and month(entry_date)='" . $s_month . "' and year(entry_date)='" . $s_year . "' and sms_type='1'";


//********************
//$sqlquery = "select msisdn, score,contest_id,keyword,shortcode from today_score where contest_id='" . $cntsid . "' and entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and sms_type='1'";
//********************
	...
	if ($shortcode != ""){
		if ($shortcode == "all"){
			if ($keyword == "all"){
				...
				$sqlquery1 = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and keyword='" . $keyword . "' and sms_type='1' limit $eu, $limit";
			}
		}else{
			if ($keyword == "all"){
				$sqlquery1 = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and shortcode='" . $shortcode . "' and sms_type='1' limit $eu, $limit";
			}else{
				$sqlquery1 = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and shortcode='" . $shortcode . "' and keyword='" . $keyword . "' and sms_type='1' limit $eu, $limit";
			}
		}
	}
}else{
		...
		if ($sms_type == 1){
			if ($shortcode != ""){
				if ($shortcode == "all"){
					...
					$sqlquery1 = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and contest_id='" . $cntsid . "' and shortcode='" . $shortcode . "' and sms_type='1' limit $eu, $limit";
				}
			}
		}else{
			$sqlquery1 = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and contest_id='" . $cntsid . "' and sms_type<>'1' limit $eu, $limit";
