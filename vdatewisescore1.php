...
if ($keywordmis == 1){
	if ($shortcode != ""){
		if ($shortcode == "all"){
			if ($keyword == "all"){
				$sqlquery = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "'";
			}else{
				$sqlquery = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and keyword='" . $keyword . "'";
			}
		}else{
			if ($keyword == "all"){
				$sqlquery = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and shortcode='" . $shortcode . "'";
			}else{
				$sqlquery = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and shortcode='" . $shortcode . "' and keyword='" . $keyword . "'";
			}
		}
	}
}else{
	if ($cntsid == "all"){
		if ($sms_type == 1){
			...
			$sqlquery = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and sms_type<>'1'";
		}
	}else{
		if ($sms_type == 1){
			if ($shortcode != ""){
				if ($shortcode == "all"){
					$sqlquery = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and contest_id='" . $cntsid . "'";
				}else{
					$sqlquery = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and contest_id='" . $cntsid . "' and shortcode='" . $shortcode . "'";
				}
			}
		}else{
			$sqlquery = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and contest_id='" . $cntsid . "' and sms_type<>'1'";
		}
	}
}
...
//$sqlquery = "select msisdn, score,contest_id,keyword,shortcode from today_score where contest_id='" . $cntsid . "' and day(entry_date)='" . $s_day . "' and month(entry_date)='" . $s_month . "' and year(entry_date)='" . $s_year . "'";


//********************
//$sqlquery = "select msisdn, score,contest_id,keyword,shortcode from today_score where contest_id='" . $cntsid . "' and entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "'";
//********************
...
if ($keywordmis == 1){
	if ($shortcode != ""){
		if ($shortcode == "all"){
			if ($keyword == "all"){
				$sqlquery1 = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' limit $eu, $limit";
			}else{
				$sqlquery1 = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and keyword='" . $keyword . "' limit $eu, $limit";
			}
		}else{
			if ($keyword == "all"){
				$sqlquery1 = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and shortcode='" . $shortcode . "' limit $eu, $limit";
			}else{
				$sqlquery1 = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and shortcode='" . $shortcode . "' and keyword='" . $keyword . "' limit $eu, $limit";
			}
		}
	}
}else{
	if ($cntsid == "all"){
		if ($sms_type == 1){
			...
			$sqlquery1 = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and sms_type<>'1' limit $eu, $limit";
		}
	}else{
		if ($sms_type == 1){
			if ($shortcode != ""){
				if ($shortcode == "all"){
					$sqlquery1 = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and contest_id='" . $cntsid . "' limit $eu, $limit";
				}else{
					$sqlquery1 = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and contest_id='" . $cntsid . "' and shortcode='" . $shortcode . "' limit $eu, $limit";
				}
			}
		}else{
			$sqlquery1 = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and contest_id='" . $cntsid . "' and sms_type<>'1' limit $eu, $limit";
		}
	}
}
...
//**************
//$sqlquery1 = "select msisdn, score,contest_id,keyword,shortcode from today_score where contest_id='" . $cntsid . "' and entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' limit $eu, $limit";
//**************
//echo $sqlquery1;
							...
							<?if ($sms_type == 1){?>
								<table align="left" border="0" cellspacing="1" cellpadding="1" width="748px" bgcolor="#525200" style="table-layout:fixed;">
									...
									<?while ($noticia = mysql_fetch_array($result1)){
										...
										$sqlquery = "select voting_name from voting_detail where voting_id='" . $contestid . "'";
										$result = mysql_query($sqlquery) or die('mysql error:' . mysql_error());
