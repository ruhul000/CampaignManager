...
<form name="list_create" id="list_create" action="list_update.php" method="post">
<table align="left" border="0" cellspacing="1" cellpadding="0" width="748px" bgcolor="#525200">
    <tr>
        <td>
            <table align="center" border="0" cellspacing="0" cellpadding="0" width="748px" bgcolor="#f4f4e4">
                    ...
                    <td colspan="2">
                        ...
                        <?}?>
							...
							<tr height="16" bgcolor="#D9D9A8">
                                ...
                                <td align="left" valign="top" class="WorkGreen">
                                	<input class="input" type="text" name="msgln" size="8" maxlength="6" value="<? echo $msgln; ?>" onmouseover="showIT('Specify the total number that you want the SMS / PUSH message to be delivered out of the target group created.')" onmouseout="showIT()"/>
                                </td>
							</tr>
							<tr height="8px" bgcolor="#D9D9A8"><td colspan="4"></td></tr>
...
<?	}
                            ...
                            <tr height="16px" bgcolor="#D9D9A8">
								...
								<td align="left" class="WorkGreen">
									<input type="text" name ="sender_id" value="<? echo $sender_id ?>" onmouseover="showIT('Enter sender id.')" onmouseout="showIT()"/>&nbsp;&nbsp;&nbsp;&nbsp;
								</td>
