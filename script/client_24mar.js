...
function group_submit(frmname){var thisform=document.getElementById(frmname);with (thisform){if (null_chk(grp_name,"Enter the Group name!")==true||alpha_chk(grp_name,'Name should starts with an alphabet. Spaces not allowed. Underscores are acceptable')==false){return false;}else if (null_chk(grp_desc,"Enter the description of the Group!")==true||text_chk(grp_desc,'Please do not filled space in beginnig of group description')==false){return false;}else{thisform.submit();}}	};
...
function bulksms_submit(frmname){
    ...
    with (thisform){
    	if (document.forms[0].elements[0].checked==false && document.forms[0].elements[1].checked==false){
            ...
            document.forms[0].elements[0].focus;
            return false;
        }else if (document.forms[0].elements[0].checked && (null_chk(sms_msg,"Please Enter Text SMS Message")==true||text_chk(sms_msg,'Please Do Not Filled Space In Beginnig Of Text SMS Message')==false)){
            return false;
        }else if (document.forms[0].elements[1].checked==true && (null_chk(wap_title,"Please Enter WAP SMS Title")==true||text_chk(wap_title,'Please Do Not Filled Space In Beginnig Of WAP SMS Title')==false)){
            return false;
