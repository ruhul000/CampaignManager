...
if(gettype($checkcnt)=='array' && $action==2){
	...
	$sqlquery="update voting_detail set archive=1 where voting_id in (" . $ids . ") and login='" . $login_form . "'";
	$result=mysql_query($sqlquery) or die('mysql error:' . mysql_error());
	$msg_alert="Voting " . $ids . " Successfully Archived!!!";
}
$cnt=0;
$sqlquery="select voting_id,application_id,voting_name,start_date,end_date,active_status from voting_detail where archive=0 and login='" . $login_form . "' limit 10";
$result=mysql_query($sqlquery) or die('mysql error:' . mysql_error());
...
if($msg_alert=="" || stripos($msg_alert,"Successfully Archived!!!")===false){
	$msg="Voting Archive Choosess";
}else{
	$msg=$msg_alert;
}

user_session($login_form,$sess_id,"Voting Archive Choosess");
	...
	<table align="left" border="0" cellspacing="1" cellpadding="0" width="748px" bgcolor="#525200">
		<tr><td>
			<table align="center" border="0" cellspacing="0" cellpadding="0" width="748px" bgcolor="#f4f4e4">
				<TR height="26"><TD align="left" class="WorkWht" background="images/trgt_hdr1.gif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/3.png" border="0">&nbsp;&nbsp;&nbsp;Voting Archive</TD></tr>
				<tr><td>
...
<?die();}?>
	<form name="archive_form" id="archive_form" action="voting_archive.php?login=<? echo $login_form; ?>&sess_id=<? echo $sess_id; ?>" method="post">
		<table align="left" border="0" cellspacing="0" cellpadding="1" width="748px" bgcolor="#525200"  class="sortable">
			<tr>
				<td>
					<table align="left" border="0" cellspacing="0" cellpadding="0" width="748px" bgcolor="#525200">
						<tr height="28">
							<TD align="left" background="images/trgt_hdr1.gif" class="WorkWht">&nbsp;&nbsp;&nbsp;<img src="images/3.png" border="0">&nbsp;&nbsp;&nbsp;Voting Archive</TD>
						</tr>
						<tr>
							<td>
								<table align="left" border="0" cellspacing="0" cellpadding="0" width="748px" bgcolor="#525200">
...
<?}?>
									...
									<tr height="16" bgcolor="#D9D9A8">
										<td align="center" class="WorkGreen" colspan="5"><input type="button" onclick="voting_archive('archive_form')" class="submit1" value="Archive Here!!!" style="background-image:url('images/menu1.gif');" tabindex="20"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
									</tr>
									<tr height="16" bgcolor="#D9D9A8"><td colspan="5"></td></tr>
<?
