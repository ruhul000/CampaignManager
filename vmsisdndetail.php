...
if ($keywordmis == 1){
	if ($shortcode != ""){
		if ($shortcode == "all"){
			if ($keyword == "all"){
				$sqlquery = "select server_response, user_request from voting_transaction_log where msisdn='" . $msisdn . "' and request_datetime>='" . $start_date . "' and request_datetime<='" . $end_date ."' and sms_type='1'";
			}else{
				$sqlquery = "select server_response, user_request from voting_transaction_log where msisdn='" . $msisdn . "' and keyword='" . $keyword . "' and request_datetime>='" . $start_date . "' and request_datetime<='" . $end_date ."' and sms_type='1'";
			}
		}else{
			if ($keyword == "all"){
				$sqlquery = "select server_response, user_request from voting_transaction_log where msisdn='" . $msisdn . "' and shortcode='" . $shortcode . "' and request_datetime>='" . $start_date . "' and request_datetime<='" . $end_date ."' and sms_type='1'";
			}else{
				$sqlquery = "select server_response, user_request from voting_transaction_log where msisdn='" . $msisdn . "' and shortcode='" . $shortcode . "' and keyword='" . $keyword . "' and request_datetime>='" . $start_date . "' and request_datetime<='" . $end_date ."' and sms_type='1'";
			}
		}
	}
}else{
	if ($cntsid == "all"){
		...
		if ($sms_type == 1){
			if ($shortcode != ""){
				if ($shortcode == "all"){
					$sqlquery = "select server_response, user_request from voting_transaction_log where msisdn='" . $msisdn . "' and request_datetime>='" . $start_date . "' and request_datetime<='" . $end_date ."' and voting_id='" . $cntsid . "' and sms_type='1'";
				}else{
					$sqlquery = "select server_response, user_request from voting_transaction_log where msisdn='" . $msisdn . "' and shortcode='" . $shortcode . "' and request_datetime>='" . $start_date . "' and request_datetime<='" . $end_date ."' and voting_id='" . $cntsid . "' and sms_type='1'";
				}
			}
		}else{
			$sqlquery = "select server_response, user_request from voting_transaction_log where msisdn='" . $msisdn . "' and request_datetime>='" . $start_date . "' and request_datetime<='" . $end_date ."' and voting_id='" . $cntsid . "' and sms_type<>'1'";
...
//$sqlquery = "select msisdn, score, question_counter, question_correctly_answered from voting_transaction_log where voting_id='" . $cntsid . "' and entry_datetime between '" . $start_date . "' and '" . $to_date . "' and sms_type='1'";
//echo $sqlquery;
...
if ($keywordmis == 1){
	if ($shortcode != ""){
		if ($shortcode == "all"){
			if ($keyword == "all"){
				$sqlquery1 = "select server_response, user_request from voting_transaction_log where msisdn='" . $msisdn . "' and request_datetime>='" . $start_date . "' and request_datetime<='" . $end_date ."' and sms_type='1' limit $eu, $limit";
			}else{
				$sqlquery1 = "select server_response, user_request from voting_transaction_log where msisdn='" . $msisdn . "' and keyword='" . $keyword . "' and request_datetime>='" . $start_date . "' and request_datetime<='" . $end_date ."' and sms_type='1' limit $eu, $limit";
			}
		}else{
			if ($keyword == "all"){
				$sqlquery1 = "select server_response, user_request from voting_transaction_log where msisdn='" . $msisdn . "' and shortcode='" . $shortcode . "' and request_datetime>='" . $start_date . "' and request_datetime<='" . $end_date ."' and sms_type='1' limit $eu, $limit";
			}else{
				$sqlquery1 = "select server_response, user_request from voting_transaction_log where msisdn='" . $msisdn . "' and shortcode='" . $shortcode . "' and keyword='" . $keyword . "' and request_datetime>='" . $start_date . "' and request_datetime<='" . $end_date ."' and sms_type='1' limit $eu, $limit";
			}
		}
	}
}else{
	if ($cntsid == "all"){
		...
		if ($sms_type == 1){
			if ($shortcode != ""){
				if ($shortcode == "all"){
					$sqlquery1 = "select server_response, user_request from voting_transaction_log where msisdn='" . $msisdn . "' and request_datetime>='" . $start_date . "' and request_datetime<='" . $end_date ."' and voting_id='" . $cntsid . "' and sms_type='1' limit $eu, $limit";
				}else{
					$sqlquery1 = "select server_response, user_request from voting_transaction_log where msisdn='" . $msisdn . "' and shortcode='" . $shortcode . "' and request_datetime>='" . $start_date . "' and request_datetime<='" . $end_date ."' and voting_id='" . $cntsid . "' and sms_type='1' limit $eu, $limit";
				}
			}
		}else{
			$sqlquery1 = "select server_response, user_request from voting_transaction_log where msisdn='" . $msisdn . "' and request_datetime>='" . $start_date . "' and request_datetime<='" . $end_date ."' and voting_id='" . $cntsid . "' and sms_type<>'1' limit $eu, $limit";
...
//$sqlquery1 = "select server_response, user_request from voting_transaction_log where msisdn='" . $msisdn . "' and voting_id='" . $cntsid . "' and request_datetime>='" . $start_date . "' and request_datetime<='" . $end_date ."' and sms_type='1' limit $eu, $limit";
