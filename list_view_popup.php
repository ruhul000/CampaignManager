...
<form name="list_view" id="list_view" action="list_update_popup.php" method="post">
<table align="left" border="0" cellspacing="1" cellpadding="0" width="748px" bgcolor="#525200">
	<tr>
		<td>
			<table align="center" border="0" cellspacing="0" cellpadding="0" width="748px" bgcolor="#f4f4e4">
					...
					<td colspan="3">
						...
						<? } ?>
                            ...
                            <tr height="16px" bgcolor="#D9D9A8">
                                ...
                                <td align="left" valign="top" bgcolor="#f4f4e4" class="WorkGreen"><? echo $schlr_name; ?></td>
                                <td  align="right" valign="top" class="WorkGreen">Target Name&nbsp;:&nbsp;</td>
                                <td align="left" valign="top" bgcolor="#f4f4e4" class="WorkGreen"><? echo $target_name; ?></td>
                            </tr>
                            <tr height="8px" bgcolor="#D9D9A8"><td colspan="4"></td></tr>

                            <tr height="16px" bgcolor="#D9D9A8">
                                <td  align="right" valign="top" class="WorkGreen">Beginning Date&nbsp;:&nbsp;</td>
                                <td align="left" valign="top" bgcolor="#f4f4e4" class="WorkGreen"><? echo $s_date; ?></td>
								<td  align="right" valign="top" class="WorkGreen">Ending Date&nbsp;:&nbsp;</td>
								<td align="left" valign="top" bgcolor="#f4f4e4" class="WorkGreen"><? echo $e_date; ?></td>
                            </tr>
                            <tr height="8px" bgcolor="#D9D9A8"><td colspan="4"></td></tr>

                            <tr height="16px" bgcolor="#D9D9A8">
                                <td  align="right" valign="top" class="WorkGreen">Beginning Time&nbsp;:&nbsp;</td>
                                <td align="left" valign="top" bgcolor="#f4f4e4" class="WorkGreen">
                            ...
                            <tr height="16px" bgcolor="#D9D9A8">
                                ...
                                <td align="left" valign="top" bgcolor="#f4f4e4" class="WorkGreen"><? if($sms_mode==2){echo "Wap Push";}else{echo "Text Base";} ?></td>
                                <td align="right" valign="top" class="WorkGreen"><? if($sms_mode==2){echo "Title";}else{echo "Message";} ?>&nbsp;:&nbsp;</TD>
                                <td align="left" valign="top" bgcolor="#f4f4e4" class="WorkGreen"><? echo $message; ?></td>
							</tr>
                            <tr height="8px" bgcolor="#D9D9A8"><td colspan="4"></td></tr>

                            <tr height="16px" bgcolor="#D9D9A8">
                                <td  align="right" valign="top" class="WorkGreen"><? if($sms_mode==2){echo "URL";}else{echo "Footer Message";} ?>&nbsp;:&nbsp;</TD>
                                <td align="left" valign="top" bgcolor="#f4f4e4" class="WorkGreen"><? echo $footer_url; ?></td>
								<td  align="right" valign="top" class="WorkGreen">No of Messages&nbsp;:&nbsp;</td>
								<td align="left" valign="top" bgcolor="#f4f4e4" class="WorkGreen"><? echo $msgln; ?></td>
							</tr>
							<tr height="8px" bgcolor="#D9D9A8"><td colspan="4"></td></tr>

                            <tr height="16px" bgcolor="#D9D9A8">
                              	<td align="right" class="WorkGreen">Active Status&nbsp;:&nbsp;</td>
								<td align="left" bgcolor="#f4f4e4" class="WorkGreen"><?if ($status==1){ echo "On"; }else{echo "Off"; }?></td>
								<td align="right" class="WorkGreen">Sender Id&nbsp;:&nbsp;</td>
								<td align="left" bgcolor="#f4f4e4" class="WorkGreen"><?=$sender_id ?></td>
							</tr>
							<tr height="8px" bgcolor="#D9D9A8"><td colspan="4"></td></tr>
							<tr height="16px" bgcolor="#D9D9A8"><td colspan="4" align="center" class="WorkGreen"><input type="button" value="Close!!" class="submit1" onclick="JavaScript:window.close();" style="background-image:url('images/menu1.gif');" tabindex="33"></td></tr>
							<tr height="8px" bgcolor="#D9D9A8"><td colspan="4"></td></tr>
...
<?
	...
	print "<input type=\"hidden\" name=\"sender_id\" value=" . $sender_id . ">";
?>
                        </table>
                    </td>
                </tr>
