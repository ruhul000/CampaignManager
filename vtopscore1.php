...
if ($keywordmis == 1){
	if ($shortcode != ""){
		if ($shortcode == "all"){
			if ($keyword == "all"){
				$sqlquery = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' limit " . $topusers . "";
			}else{
				$sqlquery = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and keyword='" . $keyword . "' limit " . $topusers . "";
			}
		}else{
			if ($keyword == "all"){
				$sqlquery = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and shortcode='" . $shortcode . "' limit " . $topusers . "";
			}else{
				$sqlquery = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and shortcode='" . $shortcode . "' and keyword='" . $keyword . "' limit " . $topusers . "";
			}
		}
	}
}else{
	if ($cntsid == "all"){
		...
		if ($sms_type == 1){
			if ($shortcode != ""){
				if ($shortcode == "all"){
					$sqlquery = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and contest_id='" . $cntsid . "' limit " . $topusers . "";
				}else{
					$sqlquery = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and contest_id='" . $cntsid . "' and shortcode='" . $shortcode . "' limit " . $topusers . "";
				}
			}
		}else{
...
if ($keywordmis == 1){
	if ($shortcode != ""){
		if ($shortcode == "all"){
			if ($keyword == "all"){
				$sqlquery1 = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' order by score desc limit $eu, $limit";
			}else{
				$sqlquery1 = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and keyword='" . $keyword . "' order by score desc limit $eu, $limit";
			}
		}else{
			if ($keyword == "all"){
				$sqlquery1 = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and shortcode='" . $shortcode . "' order by score desc limit $eu, $limit";
			}else{
				$sqlquery1 = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and shortcode='" . $shortcode . "' and keyword='" . $keyword . "' order by score desc limit $eu, $limit";
			}
		}
	}
}else{
	if ($cntsid == "all"){
		...
		if ($sms_type == 1){
			if ($shortcode != ""){
				if ($shortcode == "all"){
					$sqlquery1 = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and contest_id='" . $cntsid . "' order by score desc limit $eu, $limit";
				}else{
					$sqlquery1 = "select msisdn, score,contest_id,keyword,shortcode from today_score where entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' and contest_id='" . $cntsid . "' and shortcode='" . $shortcode . "' order by score desc limit $eu, $limit";
				}
			}
		}else{
...
//**************
//$sqlquery1 = "select msisdn, score,contest_id,keyword,shortcode from today_score where contest_id='" . $cntsid . "' and entry_date>='" . $start_date . "' and entry_date<='" . $end_date . "' order by score desc limit $eu, $limit";
//**************
//echo $sqlquery1;
