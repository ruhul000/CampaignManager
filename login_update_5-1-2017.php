...
function insert_group ()
{
	...
	$sqlquery = "insert  into access_detail
	             ...
	             (now(),'$grp_desc','$password','2','1,2,3,4,5,6,7','1','$grp_name','$name','$comname','$address','$eml', '$contactnum','CompanyAdmin')";
...
{
	global $strurl,$login_form,$sess_id,$grp_name,$grp_desc,$active_status,$password,$name,$comname,$address,$contactnum,$eml,$login_type,$user_type;
