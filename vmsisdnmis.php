...
if ($mistype == 1){
	if (strtolower($login_form) == "admin"){
		...
		$sqlquery = "select contest_id, contest_name from contest_detail where login='" . $login_form . "'";
	}
	...
	if (strtolower($login_form) == "admin"){
		...
		$sqlquery = "select voting_id, voting_name from voting_detail where login='" . $login_form . "'";
	}
...
<form name="contest_form" action="vmsisdnmisshow.php" method="post" onsubmit="return isValid()">
    ...
    <tr>
        <td>
            <table align="center" border="0" cellspacing="0" cellpadding="0" width="748px" bgcolor="#f4f4e4">
                <TR height="26">
                    <TD align="left" class="WorkWht" background="images/trgt_hdr1.gif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/3.png" border="0">&nbsp;&nbsp;&nbsp;MSISDN Wise Report</TD>
                        ...
                        <?}?>
							...
							<tr height="20px" bgcolor="#D9D9A8">
								...
								<td align="left" class="WorkGreen" colspan="2">
									<input class="input" type="text" id="s_date" name='s_date' value="<? echo $s_date; ?>" readonly="readonly" tabindex="-1" />
								...
								<td colspan="3">
									<div id="txtsms" <? if($sms_type==1||!$sms_type){echo "style=\"display:inline\"";}else{echo "style=\"display:none\"";} ?>>
										<table border="0" cellspacing="0" cellpadding="0" width="748px">
											...
											<?if ($mistype == 1){?>
												<tr height="16" bgcolor="#D9D9A8">
													<td align="center" class="WorkGreen" colspan="3"><input type="button" class="submit1" value="Submit Here!!!" onclick="contest_msisdn('contest_form');" style="background-image:url('images/menu1.gif');" tabindex="33"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
												</tr>
											<?}else{?>
												<tr height="16" bgcolor="#D9D9A8">
													<td align="center" class="WorkGreen" colspan="3"><input type="button" class="submit1" value="Submit Here!!!" onclick="voting_msisdn('contest_form');" style="background-image:url('images/menu1.gif');" tabindex="33"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
												</tr>
											<?}?>
								...
								<td colspan="3">
									<div id="wapsms" <? if($sms_type==2){echo "style=\"display:inline\"";}else{echo "style=\"display:none\"";} ?>>
										<table border="0" cellspacing="0" cellpadding="0" width="748px">
											<?if ($mistype == 1){?>
												<tr height="16" bgcolor="#D9D9A8">
													<td align="center" class="WorkGreen" colspan="3"><input type="button" class="submit1" value="Submit Here!!!" onclick="contest_msisdn1('contest_form');" style="background-image:url('images/menu1.gif');" tabindex="33"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
												</tr>
											<?}else{?>
												<tr height="16" bgcolor="#D9D9A8">
													<td align="center" class="WorkGreen" colspan="3"><input type="button" class="submit1" value="Submit Here!!!" onclick="voting_msisdn1('contest_form');" style="background-image:url('images/menu1.gif');" tabindex="33"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
												</tr>
											<?}?>
										</table>
									</div>
