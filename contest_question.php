...
if($msg_alert==""){
	$msg="Contest Question Add Choosess";
}else{
	$msg=$msg_alert;
}
...
while($row = mysql_fetch_row($result)){
	...
	$contest_type=($row[3]==1)?"Continuous":"Stop on error";
...
if ($ques_no==1){
	$prev_text=$welcome_message . ". Your 1st Q: " . $options . " " . $fut_msg;
...
?>
<script src="contest_js.js"></script>
...
if(q_no==1){header_val="<? echo $welcome_message; ?>"+"Your 1st Q: "+prev_qstn+" "+opt+" "+"<? echo  $fut_msg;?>";}
if(q_no>1 ){header_val="Your score is [score]. Your next Q: "+prev_qstn+" "+opt+" "+"<? echo  $fut_msg;?>";}
...
<form name="question_form" id="question_form" action="question_update.php" method="post">
	...
	<tr>
		<td>
			<table align="center" border="0" cellspacing="0" cellpadding="0" width="100%" bgcolor="#f4f4e4">
				<TR>
					<TD height="26" width="80%" class="WorkWht" background="images/trgt_hdr1.gif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/3.png" border="0">&nbsp;&nbsp;&nbsp;Contest Question Creation</TD>
...
<? if ($cntsid != ""){ ?>
								...
								<tr>
									<td align="right" class="WorkGreen" bgcolor="#D9D9A8">Contest Type&nbsp;:&nbsp;</td>
									<td align="left" bgcolor="#f4f4e4"><? echo $contest_type; ?></td>
									<TD  bgcolor="#D9D9A8" align="center">&nbsp;</TD>
								</tr>
								<tr height="8"><td colspan="3" bgcolor="#D9D9A8"></td></tr>
								...
								<tr>
									...
									<td align="left" bgcolor="#D9D9A8">
										<input onMouseOver="showIT('Enter the Contest Question')" onMouseOut="showIT()" type="text" name="question" value = "<? echo $cnts_question; ?>" size=50 class="input" onkeyup="PrevQuestion(this.value,this.name)">
									</td>
									<TD  bgcolor="#D9D9A8" align="center">&nbsp;</TD>
								</tr>
								<tr height="8"><td colspan="3" bgcolor="#D9D9A8"></td></tr>
...
<?for ($j=0;$j<$max_option;$j++){?>
								<tr>
									...
									<td align="left" bgcolor="#D9D9A8">
										<input onMouseOver="showIT('The answer option that you want to provide for the multiple choice contest question.')" onMouseOut="showIT()" type="text" name="<? echo 'opt_' . chr($j+97);?>" value = "<? echo ${'opt_' . chr($j+97)};?>" size=50 class="input" onkeyup="PrevQuestion(this.value,this.name)">
									</td>
									<TD  bgcolor="#D9D9A8" align="center">&nbsp;</TD>
								</tr>
								<tr height="8"><td colspan="3" bgcolor="#D9D9A8"></td></tr>
<?}?>
								<tr>
									<td align="right" class="WorkGreen" bgcolor="#D9D9A8">Answer&nbsp;:&nbsp;</td>
									<td align="left" valign="top" bgcolor="#D9D9A8">
<?for ($j=0;$j<$max_option;$j++){?>
	&nbsp;&nbsp;<? echo chr($j+65); ?>&nbsp;&nbsp;<input onMouseOver="showIT('Select the correct option')" onMouseOut="showIT()" type="radio" name="cnts_ans" value = "<? echo chr($j+97); ?>" <?if(ord($cnts_ans)==($j+97)){echo "checked=\"checked\"";}?>>
<?}?>
									</td>
									<TD  bgcolor="#D9D9A8" align="center">&nbsp;</TD>
								</tr>
								...
								<tr height="8"><td colspan="3" bgcolor="#D9D9A8"></td></tr>
									...
									<tr>
										<td bgcolor="#D9D9A8" align="right" colspan="2"><input type="button" onclick="question_submit('question_form','<? echo $max_option; ?>')" class="submit1" value="Insert Here!!!" style="background-image:url('images/menu1.gif');"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
										<TD bgcolor="#D9D9A8" align="center">&nbsp;</TD>
