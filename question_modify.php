...
if($msg_alert=="" || stripos($msg_alert,"Contest Question Successfully Updated!!!")!==false){
	$msg="Contest Question Modification Choosess";
}else{
	$msg=$msg_alert;
}
...
if($flag){
	$sqlquery = "select contest_id, ques_no, question, a, b, c, d, active_status, max_options, ans from contest_questions where id='" . $qutn_id . "' and contest_id='" . $cntsid . "' and login='" . $login_form . "'";
	$result = mysql_query($sqlquery) or die('mysql error:' . mysql_error());
	while($row = mysql_fetch_row($result)){
		$ques_no = $row[1];
		$question = $row[2];
...
if ($ques_no == 1){
	$prev_text = $welcome_header . " Your 1st Q:" . $question . " " . $options . " " . $fut_msg;
...
<form name="question_modify" id="question_modify" action="question_update.php" method="post">
	...
	<tr>
		<td>
			<table align="center" border="0" cellspacing="0" cellpadding="0" width="100%" bgcolor="#f4f4e4">
				<TR>
					<TD height="26" width="80%" class="WorkWht" background="images/trgt_hdr1.gif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/3.png" border="0">&nbsp;&nbsp;&nbsp;Contest Question Modification</TD>
					...
					<?if (strlen($msg_alert) > 0){?>
							...
							<tr>
								...
								<td align="left" bgcolor="#D9D9A8">
									<input onMouseOver="showIT('Update the Contest Question')" onMouseOut="showIT()" type="text" name="question" value="<? echo $question; ?>" size=50 class="input" onkeyup="PrevQuestion(this.value,this.name)">
								</td>
								<TD  bgcolor="#D9D9A8" align="center">&nbsp;</TD>
							</tr>
							<tr height="8"><td colspan="3" bgcolor="#D9D9A8"></td></tr>
...
<?}?>
							...
							<tr>
								...
								<td align="left" bgcolor="#D9D9A8">
									<textarea onFocus="this.blur()" READONLY onMouseOver="showIT('Preview of the question')" onMouseOut="showIT()" rows="6" cols="49" name="prev" class="input" onKeyDown="CountLeft(this.form.an_msg1,this.form.left1,160);" onKeyUp="CountLeft(this.form.an_msg1,this.form.left1,160);"><? echo $prev_text; ?></textarea>
								</td>
								<TD  bgcolor="#D9D9A8" align="center">&nbsp;</TD>
							</tr>
							<tr height="8"><td colspan="3" bgcolor="#D9D9A8"></td></tr>
