...
if (strtolower($login_form) == "admin"){
	...
	$sqlquery = "select contest_id, contest_name from contest_detail where archive!=1 and login='" . $login_form . "'";
}
...
<form name="contest_form" action="topscore1.php" method="post" onsubmit="return isValid()">
